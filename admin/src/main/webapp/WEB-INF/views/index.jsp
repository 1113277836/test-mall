		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover">
					<a href="#" class="dropDown_A">${sessionScope.username} <i class="Hui-iconfont">&#xe6d5;</i></a>
					<ul class="dropDown-menu menu radius box-shadow">
						<li><a href="${ctx}/user/zx">退出</a></li>
				</ul>
			</li>
...
<aside class="Hui-aside">
	...
	<%--</dl>--%>
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a data-href="${ctx}/brand/queryAllBrand" data-title="品牌管理" href="javascript:void(0)">品牌管理</a></li>
					<li><a data-href="${ctx}/category/queryCategory" data-title="分类管理" href="javascript:void(0)">分类管理</a></li>
					<li><a data-href="${ctx}/product/queryAllProduct" data-title="产品管理" href="javascript:void(0)">产品管理</a></li>
					<li><a data-href="${ctx}/product//queryAllOrders" data-title="订单管理" href="javascript:void(0)">订单管理</a></li>
				</ul>
		</dd>
	</dl>
		<%--<dl id="menu-comments">--%>
	...
	<%--</dl>--%>
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="${ctx}/member/queryAllMember" data-title="会员列表" href="javascript:;">会员列表</a></li>
					<li><a data-href="${ctx}/member/queryAllDeleteMember" data-title="删除的会员" href="javascript:;">删除的会员</a></li>
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					...
					<li><a data-href="${ctx}/user/queryAllUser" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
			</ul>
		</dd>
	</dl>
		<%--<dl id="menu-tongji">--%>
