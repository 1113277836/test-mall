...
<article class="page-container">
	<form action="${ctx}/member/addOrUpdateMember" method="post" >
		<input type="hidden" name="id" value="${requestScope.member.id}">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>用户名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${requestScope.member.username}" placeholder="" name="username">
			</div>
		</div>
		<%--<div class="row cl">--%>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${requestScope.member.tel}" placeholder="" name="tel">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>身份证：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${requestScope.member.idNumber}" placeholder="请输入有效身份证件号" name="idNumber">
			</div>
		</div>
		<%--<div class="row cl">--%>
