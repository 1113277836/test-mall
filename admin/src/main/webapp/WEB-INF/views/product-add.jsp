...
<div class="page-container">
	<form enctype="multipart/form-data" action="${ctx}/product/addOrUpdateProduct" method="post" class="form form-horizontal" id="form-article-add">
		<input type="hidden" name="id" value="${requestScope.product.id}">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>产品标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${requestScope.product.pname}" placeholder="" name="pname">
			</div>
			<br/>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="category_id" class="select">
					<c:forEach items="${requestScope.categories}" var="map">
					<option value="${map.id}"
						<c:if test="${requestScope.product.category_id==map.id}">
							selected="selected"
						</c:if>
					>
							${map.name}
			...
			<div class="row cl">
				...
				<select name="brand_id" class="select">
					<c:forEach items="${requestScope.brands}" var="map">
						<option value="${map.id}"
						<c:if test="${requestScope.product.brand_id==map.id}">
							selected="selected"
						</c:if>
						>${map.name}
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" value="${requestScope.product.inventory}" placeholder="" name="inventory">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">产品原价：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" name="yprice"  placeholder="" value="${requestScope.product.yprice}" class="input-text" style="width:90%">
				元</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">产品现价：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" name="xprice" placeholder="" value="${requestScope.product.xprice}" class="input-text" style="width:90%">
				元</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input name="describes" cols="" rows="" class="textarea" value="${requestScope.product.describes}" placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)"/>
...
<script type="text/javascript">
    $(function () {
        $("a[name=id]").click(function () {
            ...
            $.ajax({
                //请求地址
                url: "${ctx}/category/queryBrandByCid",
                //请求类型
                type: "POST",
                //请求参数
                data: {
